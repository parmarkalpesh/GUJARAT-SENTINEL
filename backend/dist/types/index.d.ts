...
export type WSEventType = 'alert:new' | 'alert:updated' | 'detection:new' | 'camera:status' | 'incident:new' | 'incident:updated' | 'demo:phase' | 'demo:event' | 'metrics:update' | 'system:status';
